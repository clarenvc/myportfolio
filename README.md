...
2. cd myportfolio
3. python -m venv env
4. source env/bin/activate (for macOS) or env\Scripts\activate (for Windows)
...
P.S. Tugas 1 ini saya kerjakan dengan bantuan AI, gemini, untuk memodifikasi style.css. Khususnya saya gunakan untuk mencari perkiraan sumber error dari _source code_ dimana masih saya lakukan pengecekan sendiri agar saya lihat langsung dan menjadi pelajaran untuk diingat kedepannya
